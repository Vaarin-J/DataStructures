...
public class Board {
    ...
    public void addRandomTile() {
        ...
        int c = openSpaces.get(t).getCol();
        int r = openSpaces.get(t).getRow();
    ...
    public void swipeLeft() {
        ...
        for(int r = 0; r<gameBoard.length; r++){
            ...
            for(int c = 0; c<gameBoard[r].length; c++){
                if(gameBoard[r][c] != 0){
                    gameBoard[r][count] = gameBoard[r][c];
                        if(count != c){
                            gameBoard[r][c] = 0;
                            }
    ...
    public void transpose() {
        ...
        for(int r = 0; r<gameBoard.length/2 + 1; r++){
            for(int c = r; c<gameBoard[0].length; c++){
    ...
    public void flipRows() {
            ...
            for(int r = 0; r<gameBoard.length; r++){
                int s = 0;
                int e = gameBoard[r].length - 1;
                    while(s < e){
                    int temp = gameBoard[r][s];
                        gameBoard[r][s] = gameBoard[r][e];
                        gameBoard[r][e] = temp;
